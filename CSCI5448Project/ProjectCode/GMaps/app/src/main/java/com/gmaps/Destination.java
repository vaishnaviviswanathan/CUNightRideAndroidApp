...
public class Destination extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void loadPickup(View view) {
        Activity activity = (Activity) context;
        Intent intent = new Intent(this, DriveLandingPage.class);
        startActivity(intent);
        System.out.println("instid pickup");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gps = new GPSTracker(Destination.this);
                ...
                if(gps.canGetLocation()) {
                    ...
                    CameraPosition cameraPosition = new CameraPosition.Builder().target(latLngDriver).zoom(13).bearing(0).build();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        List<String> destinationList = Arrays.asList( "Glenlake apartments Boulder CO");
        Iterator<String> iterator = destinationList.iterator();
        try {
            ...
            while(iterator.hasNext()) {
                ...
                System.out.println("addressList" + addressList+ addressList.size());
